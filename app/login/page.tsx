      ...
      <div className="w-full max-w-sm">
        <div className="border border-white/10 bg-[#111] px-8 py-10">
          ...
          <button
            ...
            className="mb-6 flex w-full items-center justify-center gap-2.5 border border-white/15 bg-transparent px-4 py-2.5 text-sm font-medium text-white/70 transition-colors hover:border-white/30 hover:text-white"
          >
